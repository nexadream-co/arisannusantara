...
mixin _$GroupEntity {
 ...
 DateTime? get periodsDate; double? get dues; double? get target; int? get maxWinner; bool? get isOwned; bool? get isJoined; List<String>? get owners; DateTime? get createdAt; DateTime? get updatedAt; List<PaymentAccountEntity>? get paymentAccounts;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,code,reward,status,periodsType,periodsDate,dues,target,maxWinner,isOwned,isJoined,const DeepCollectionEquality().hash(owners),createdAt,updatedAt,const DeepCollectionEquality().hash(paymentAccounts));

@override
String toString() {
  return 'GroupEntity(id: $id, name: $name, description: $description, code: $code, reward: $reward, status: $status, periodsType: $periodsType, periodsDate: $periodsDate, dues: $dues, target: $target, maxWinner: $maxWinner, isOwned: $isOwned, isJoined: $isJoined, owners: $owners, createdAt: $createdAt, updatedAt: $updatedAt, paymentAccounts: $paymentAccounts)';
}
...
@useResult
$Res call({
 String? id, String? name, String? description, String? code, String? reward, String? status, String? periodsType, DateTime? periodsDate, double? dues, double? target, int? maxWinner, bool? isOwned, bool? isJoined, List<String>? owners, DateTime? createdAt, DateTime? updatedAt, List<PaymentAccountEntity>? paymentAccounts
});
...
/// Create a copy of GroupEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = freezed,Object? description = freezed,Object? code = freezed,Object? reward = freezed,Object? status = freezed,Object? periodsType = freezed,Object? periodsDate = freezed,Object? dues = freezed,Object? target = freezed,Object? maxWinner = freezed,Object? isOwned = freezed,Object? isJoined = freezed,Object? owners = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? paymentAccounts = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String? name,  String? description,  String? code,  String? reward,  String? status,  String? periodsType,  DateTime? periodsDate,  double? dues,  double? target,  int? maxWinner,  bool? isOwned,  bool? isJoined,  List<String>? owners,  DateTime? createdAt,  DateTime? updatedAt,  List<PaymentAccountEntity>? paymentAccounts)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroupEntity() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.code,_that.reward,_that.status,_that.periodsType,_that.periodsDate,_that.dues,_that.target,_that.maxWinner,_that.isOwned,_that.isJoined,_that.owners,_that.createdAt,_that.updatedAt,_that.paymentAccounts);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String? name,  String? description,  String? code,  String? reward,  String? status,  String? periodsType,  DateTime? periodsDate,  double? dues,  double? target,  int? maxWinner,  bool? isOwned,  bool? isJoined,  List<String>? owners,  DateTime? createdAt,  DateTime? updatedAt,  List<PaymentAccountEntity>? paymentAccounts)  $default,) {final _that = this;
switch (_that) {
case _GroupEntity():
return $default(_that.id,_that.name,_that.description,_that.code,_that.reward,_that.status,_that.periodsType,_that.periodsDate,_that.dues,_that.target,_that.maxWinner,_that.isOwned,_that.isJoined,_that.owners,_that.createdAt,_that.updatedAt,_that.paymentAccounts);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String? name,  String? description,  String? code,  String? reward,  String? status,  String? periodsType,  DateTime? periodsDate,  double? dues,  double? target,  int? maxWinner,  bool? isOwned,  bool? isJoined,  List<String>? owners,  DateTime? createdAt,  DateTime? updatedAt,  List<PaymentAccountEntity>? paymentAccounts)?  $default,) {final _that = this;
switch (_that) {
case _GroupEntity() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.code,_that.reward,_that.status,_that.periodsType,_that.periodsDate,_that.dues,_that.target,_that.maxWinner,_that.isOwned,_that.isJoined,_that.owners,_that.createdAt,_that.updatedAt,_that.paymentAccounts);case _:
  return null;
...
class _GroupEntity implements GroupEntity {
  const _GroupEntity({this.id, this.name, this.description, this.code, this.reward, this.status, this.periodsType, this.periodsDate, this.dues, this.target, this.maxWinner, this.isOwned, this.isJoined, final  List<String>? owners, this.createdAt, this.updatedAt, final  List<PaymentAccountEntity>? paymentAccounts}): _owners = owners,_paymentAccounts = paymentAccounts;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,code,reward,status,periodsType,periodsDate,dues,target,maxWinner,isOwned,isJoined,const DeepCollectionEquality().hash(_owners),createdAt,updatedAt,const DeepCollectionEquality().hash(_paymentAccounts));
