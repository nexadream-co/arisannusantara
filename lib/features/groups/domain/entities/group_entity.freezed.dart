...
mixin _$GroupEntity {
 ...
 DateTime? get periodsDate; double? get dues; double? get target; double? get adminFee; int? get maxWinner; bool? get isOwned; bool? get isJoined; List<String>? get owners; List<String>? get memberIds; DateTime? get createdAt; DateTime? get updatedAt; List<PaymentAccountEntity>? get paymentAccounts;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GroupEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.code, code) || other.code == code)&&(identical(other.reward, reward) || other.reward == reward)&&(identical(other.status, status) || other.status == status)&&(identical(other.periodsType, periodsType) || other.periodsType == periodsType)&&(identical(other.periodsDate, periodsDate) || other.periodsDate == periodsDate)&&(identical(other.dues, dues) || other.dues == dues)&&(identical(other.target, target) || other.target == target)&&(identical(other.adminFee, adminFee) || other.adminFee == adminFee)&&(identical(other.maxWinner, maxWinner) || other.maxWinner == maxWinner)&&(identical(other.isOwned, isOwned) || other.isOwned == isOwned)&&(identical(other.isJoined, isJoined) || other.isJoined == isJoined)&&const DeepCollectionEquality().equals(other.owners, owners)&&const DeepCollectionEquality().equals(other.memberIds, memberIds)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&const DeepCollectionEquality().equals(other.paymentAccounts, paymentAccounts));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,code,reward,status,periodsType,periodsDate,dues,target,adminFee,maxWinner,isOwned,isJoined,const DeepCollectionEquality().hash(owners),const DeepCollectionEquality().hash(memberIds),createdAt,updatedAt,const DeepCollectionEquality().hash(paymentAccounts)]);

@override
String toString() {
  return 'GroupEntity(id: $id, name: $name, description: $description, code: $code, reward: $reward, status: $status, periodsType: $periodsType, periodsDate: $periodsDate, dues: $dues, target: $target, adminFee: $adminFee, maxWinner: $maxWinner, isOwned: $isOwned, isJoined: $isJoined, owners: $owners, memberIds: $memberIds, createdAt: $createdAt, updatedAt: $updatedAt, paymentAccounts: $paymentAccounts)';
}
...
@useResult
$Res call({
 String? id, String? name, String? description, String? code, String? reward, String? status, String? periodsType, DateTime? periodsDate, double? dues, double? target, double? adminFee, int? maxWinner, bool? isOwned, bool? isJoined, List<String>? owners, List<String>? memberIds, DateTime? createdAt, DateTime? updatedAt, List<PaymentAccountEntity>? paymentAccounts
});
...
/// Create a copy of GroupEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = freezed,Object? description = freezed,Object? code = freezed,Object? reward = freezed,Object? status = freezed,Object? periodsType = freezed,Object? periodsDate = freezed,Object? dues = freezed,Object? target = freezed,Object? adminFee = freezed,Object? maxWinner = freezed,Object? isOwned = freezed,Object? isJoined = freezed,Object? owners = freezed,Object? memberIds = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? paymentAccounts = freezed,}) {
...
as double?,adminFee: freezed == adminFee ? _self.adminFee : adminFee // ignore: cast_nullable_to_non_nullable
as double?,maxWinner: freezed == maxWinner ? _self.maxWinner : maxWinner // ignore: cast_nullable_to_non_nullable
as int?,isOwned: freezed == isOwned ? _self.isOwned : isOwned // ignore: cast_nullable_to_non_nullable
as bool?,isJoined: freezed == isJoined ? _self.isJoined : isJoined // ignore: cast_nullable_to_non_nullable
as bool?,owners: freezed == owners ? _self.owners : owners // ignore: cast_nullable_to_non_nullable
as List<String>?,memberIds: freezed == memberIds ? _self.memberIds : memberIds // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String? name,  String? description,  String? code,  String? reward,  String? status,  String? periodsType,  DateTime? periodsDate,  double? dues,  double? target,  double? adminFee,  int? maxWinner,  bool? isOwned,  bool? isJoined,  List<String>? owners,  List<String>? memberIds,  DateTime? createdAt,  DateTime? updatedAt,  List<PaymentAccountEntity>? paymentAccounts)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GroupEntity() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.code,_that.reward,_that.status,_that.periodsType,_that.periodsDate,_that.dues,_that.target,_that.adminFee,_that.maxWinner,_that.isOwned,_that.isJoined,_that.owners,_that.memberIds,_that.createdAt,_that.updatedAt,_that.paymentAccounts);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String? name,  String? description,  String? code,  String? reward,  String? status,  String? periodsType,  DateTime? periodsDate,  double? dues,  double? target,  double? adminFee,  int? maxWinner,  bool? isOwned,  bool? isJoined,  List<String>? owners,  List<String>? memberIds,  DateTime? createdAt,  DateTime? updatedAt,  List<PaymentAccountEntity>? paymentAccounts)  $default,) {final _that = this;
switch (_that) {
case _GroupEntity():
return $default(_that.id,_that.name,_that.description,_that.code,_that.reward,_that.status,_that.periodsType,_that.periodsDate,_that.dues,_that.target,_that.adminFee,_that.maxWinner,_that.isOwned,_that.isJoined,_that.owners,_that.memberIds,_that.createdAt,_that.updatedAt,_that.paymentAccounts);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String? name,  String? description,  String? code,  String? reward,  String? status,  String? periodsType,  DateTime? periodsDate,  double? dues,  double? target,  double? adminFee,  int? maxWinner,  bool? isOwned,  bool? isJoined,  List<String>? owners,  List<String>? memberIds,  DateTime? createdAt,  DateTime? updatedAt,  List<PaymentAccountEntity>? paymentAccounts)?  $default,) {final _that = this;
switch (_that) {
case _GroupEntity() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.code,_that.reward,_that.status,_that.periodsType,_that.periodsDate,_that.dues,_that.target,_that.adminFee,_that.maxWinner,_that.isOwned,_that.isJoined,_that.owners,_that.memberIds,_that.createdAt,_that.updatedAt,_that.paymentAccounts);case _:
  return null;
...
class _GroupEntity implements GroupEntity {
  const _GroupEntity({this.id, this.name, this.description, this.code, this.reward, this.status, this.periodsType, this.periodsDate, this.dues, this.target, this.adminFee, this.maxWinner, this.isOwned, this.isJoined, final  List<String>? owners, final  List<String>? memberIds, this.createdAt, this.updatedAt, final  List<PaymentAccountEntity>? paymentAccounts}): _owners = owners,_memberIds = memberIds,_paymentAccounts = paymentAccounts;
...
@override final  double? adminFee;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GroupEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.code, code) || other.code == code)&&(identical(other.reward, reward) || other.reward == reward)&&(identical(other.status, status) || other.status == status)&&(identical(other.periodsType, periodsType) || other.periodsType == periodsType)&&(identical(other.periodsDate, periodsDate) || other.periodsDate == periodsDate)&&(identical(other.dues, dues) || other.dues == dues)&&(identical(other.target, target) || other.target == target)&&(identical(other.adminFee, adminFee) || other.adminFee == adminFee)&&(identical(other.maxWinner, maxWinner) || other.maxWinner == maxWinner)&&(identical(other.isOwned, isOwned) || other.isOwned == isOwned)&&(identical(other.isJoined, isJoined) || other.isJoined == isJoined)&&const DeepCollectionEquality().equals(other._owners, _owners)&&const DeepCollectionEquality().equals(other._memberIds, _memberIds)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&const DeepCollectionEquality().equals(other._paymentAccounts, _paymentAccounts));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,code,reward,status,periodsType,periodsDate,dues,target,adminFee,maxWinner,isOwned,isJoined,const DeepCollectionEquality().hash(_owners),const DeepCollectionEquality().hash(_memberIds),createdAt,updatedAt,const DeepCollectionEquality().hash(_paymentAccounts)]);
...
as int?,isOwned: freezed == isOwned ? _self.isOwned : isOwned // ignore: cast_nullable_to_non_nullable
as bool?,isJoined: freezed == isJoined ? _self.isJoined : isJoined // ignore: cast_nullable_to_non_nullable
as bool?,owners: freezed == owners ? _self._owners : owners // ignore: cast_nullable_to_non_nullable
as List<String>?,memberIds: freezed == memberIds ? _self._memberIds : memberIds // ignore: cast_nullable_to_non_nullable
as List<String>?,createdAt: freezed == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime?,updatedAt: freezed == updatedAt ? _self.updatedAt : updatedAt // ignore: cast_nullable_to_non_nullable
